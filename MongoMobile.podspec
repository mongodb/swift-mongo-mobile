Pod::Spec.new do |spec|
  ...
  if [ ! -d iphoneos ]; then
    curl https://s3.amazonaws.com/mciuploads/mongodb-mongo-master/embedded-sdk/embedded-sdk-iphoneos-10.2/9dbed1bc8108798bebc8ae7a0b56fa4858335146/mongodb_mongo_master_embedded_sdk_iphoneos_10.2_9dbed1bc8108798bebc8ae7a0b56fa4858335146_18_04_23_03_32_45.tgz > mobile-sdks.tgz
    mkdir iphoneos
  ...
  if [ ! -d iphonesimulator ]; then
    curl https://s3.amazonaws.com/mciuploads/mongodb-mongo-master/embedded-sdk/embedded-sdk-iphonesimulator-10.2/9dbed1bc8108798bebc8ae7a0b56fa4858335146/mongodb_mongo_master_embedded_sdk_iphonesimulator_10.2_9dbed1bc8108798bebc8ae7a0b56fa4858335146_18_04_23_03_32_45.tgz > mobile-sdks.tgz
  ...
  spec.user_target_xcconfig = {
    ...
    'LIBRARY_SEARCH_PATHS[sdk=iphonesimulator*]' => '$(PODS_ROOT)/MongoMobile/MobileSDKs/iphonesimulator/lib',
    'LIBRARY_SEARCH_PATHS[sdk=appletvos*]'       => '$(PODS_ROOT)/MongoMobile/MobileSDKs/appletvos/lib',
    'LIBRARY_SEARCH_PATHS[sdk=appletvsimulator*]'=> '$(PODS_ROOT)/MongoMobile/MobileSDKs/appletvsimulator/lib',
  }
end
